...
C++17 необходим, в частности, для структурированного связывания в `matrixMaximum.cpp`. Примеры команд ниже используют этот минимально достаточный стандарт. Конфигурация VS Code в этом репозитории использует C++23, GCC и LLDB; она рассчитана на Linux-среду code-server.
